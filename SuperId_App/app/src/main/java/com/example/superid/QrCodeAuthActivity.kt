    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent{
            SuperIdTheme(darkTheme = isSystemInDarkTheme()) {
                SearchLoginDocument("")
                QrCodeScannerScreen()
            }
        }
    }
